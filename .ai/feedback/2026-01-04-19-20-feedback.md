...
- [x] 根本原因特定
- [x] コード修正完了
- [x] テスト実行（67/67 passed）
- [x] dev環境デプロイ（task-definition/meeting-visualizer-dev:29）
- [x] 動作確認 ✅

### デプロイ情報

- **コミット**: 022ccbe (fix(image): Use global region for Gemini 3 Pro Image)
- **タスク定義**: meeting-visualizer-dev:29
- **デプロイ時刻**: 2026-01-04 19:40
