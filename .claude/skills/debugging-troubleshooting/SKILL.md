...
description: Systematic error diagnosis and debugging workflow for Node.js/TypeScript code. Use when code isn't working, tests fail, or runtime errors occur.
...
| ツール | 用途 | コマンド |
|--------|------|---------|
| `rust-lldb` | デバッガ | `rust-lldb target/debug/ccagi` |
| `cargo-expand` | マクロ展開 | `cargo expand` |
| `cargo-asm` | アセンブリ確認 | `cargo asm` |
| `valgrind` | メモリ診断 | `valgrind ./target/debug/ccagi` |
