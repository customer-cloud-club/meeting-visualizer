...
Agent作業が完了してHuman In The Loopが必要なときに、macOS通知を表示し、牛の鳴き声を鳴らします。
...
```bash
# 通知スクリプトを作成して実行
osascript -e 'display notification "Agent作業が完了しました！\nHuman In The Loop が必要です" with title "CCAGI Agent 完了" sound name "Purr"'
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
CCAGI Agent - Session End Notification
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
通知スクリプトを作成する場合、以下の形式を使用：

```bash
TITLE="CCAGI Agent 完了"
...
- `Purr` (デフォルト), `Sosumi`, `Submarine`, `Tink`
...
- `.claude/commands/session-end.md` - このファイル
- `.ai/logs/YYYY-MM-DD.md` - 通知履歴ログ
- `.ccagi.yml` - CCAGI設定ファイル

---

**実行開始:**

このコマンドを実行すると、即座にmacOS通知が表示され、牛の鳴き声が再生されます。
